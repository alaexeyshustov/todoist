        ...
        <aside class="w-56 bg-white border-r border-gray-200 flex flex-col shrink-0">
            <div class="flex-1 overflow-y-auto p-3 space-y-1">
                <template x-for="list in lists" :key="list.id">
                    <div class="group flex items-center gap-1 rounded-lg px-2 py-1.5 cursor-pointer"
                        ...
                        <button @click.stop="exportList(list)"
                                class="opacity-0 group-hover:opacity-100 text-gray-400 hover:text-blue-500 p-0.5 rounded"
            ...
            <div class="p-3 border-t border-gray-100 space-y-2">
                ...
                <label class="flex items-center gap-1 cursor-pointer text-xs text-gray-400 hover:text-gray-600">
                    ...
                    Import .md
                    <input type="file" accept=".md" class="hidden" @change="importList($event)">
                </label>
            </div>
        </aside>
